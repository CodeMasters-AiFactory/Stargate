...
**Business Type:** Modern, professional law firm  
...
### Visual Identity
- **Professional, confident, trustworthy** - not playful or casual
- **Primary Color:** Deep navy / dark blue (#1e3a8a or similar)
- **Accent Color:** Warm amber or copper (#d97706 or #b45309)
- **Background:** Plenty of white space
- **Typography:** Clear, modern sans-serif (Inter, Roboto, or similar)
- **Font Weight:** Strong weight contrast for headings (bold headings, regular body)
- **Visual Feel:** Clean, minimal, focused on trust and clarity
- **NO:** Playful confetti, random gradients, generic stock photos of random people
...
### H2 Headings (Must Include Keywords)
- "Who We Serve"
...
**Layout:** Full-width hero with background image (generated via DALL·E, not stock)

**Content:**
- **H1:** "Trusted Corporate, Family & Criminal Law Firm in [CITY]"
- **Subheading:** "Sterling Legal Partners helps businesses and families navigate complex legal issues with clear advice, decisive action and confidential support."
...
**Background Image:**
- Generate via DALL·E: "Professional South African law firm office, warm natural light, subtle blue and copper brand colours, confident but approachable atmosphere, no visible text"
...
- **Icon/Visual:** Business/office icon or illustration
- **Bullet Points:**
...
- **Icon/Visual:** Family/individual icon or illustration
- **Bullet Points:**
...
### 3. "PRACTICE AREAS" / SERVICES GRID

**H2:** "Our Key Practice Areas"

**3 Service Cards:**

#### Card 1: Corporate Law
- **Title:** "Corporate Law"
- **Description:** "Business formation, contracts, governance, dispute resolution and ongoing legal advisory for SMEs and growing companies."
- **Link:** "Learn more" → `/services/corporate-law` or `/services#corporate-law`

#### Card 2: Family Law
- **Title:** "Family Law"
- **Description:** "Divorce, custody, maintenance and parenting plans handled with sensitivity and firm protection of your rights."
- **Link:** "Learn more" → `/services/family-law` or `/services#family-law`

#### Card 3: Criminal Defense
- **Title:** "Criminal Defense"
- **Description:** "Strategic defense for bail applications, criminal charges and investigations, protecting your liberty and record."
- **Link:** "Learn more" → `/services/criminal-defense` or `/services#criminal-defense`

---

### 4. "WHY CLIENTS CHOOSE US" / DIFFERENTIATORS

**H2:** "Why Clients Choose Sterling Legal Partners"
...
- **Description:** "We focus on long-term outcomes, not just quick fixes."

#### 3. Personal Attention
- **Icon:** Personal/handshake icon
- **Label:** "Personal Attention"
- **Description:** "You work with a dedicated attorney who understands your situation."

#### 4. Confidential & Ethical
- **Icon:** Shield/lock icon
- **Label:** "Confidential & Ethical"
- **Description:** "Your matter is handled with discretion and integrity."

---

### 5. "CLIENT RESULTS & STORIES" (SOCIAL PROOF)

**H2:** "Client Outcomes We're Proud Of"

**3 Example Mini-Case Blurbs** (anonymised, 1-2 sentences each):

#### Case 1: Corporate
"Helped a growing tech company in [CITY] restructure shareholder agreements and avoid a costly dispute."

#### Case 2: Family Law
"Guided a parent through a complex custody matter, achieving a stable, child-focused parenting plan."

#### Case 3: Criminal Defense
"Obtained bail and a favourable outcome in a criminal matter where the client faced significant reputational risk."
...
### 6. "ABOUT THE FIRM" TEASER

**H2:** "About Sterling Legal Partners"
...
**3 Short Values** (display in a row):
...
- **Description:** "Contact us to discuss your situation confidentially."

#### Step 2: Receive a Clear Plan
- **Number:** "2"
- **Title:** "Receive a Clear Plan"
- **Description:** "We outline your legal options and recommended strategy."

#### Step 3: Move Forward With Confidence
- **Number:** "3"
- **Title:** "Move Forward With Confidence"
- **Description:** "We act on your instructions and keep you updated as your matter progresses."
...
### DO:
- ✅ Use specific location references: "[CITY]", "[REGION]"
- ✅ Include concrete service descriptions with use cases
- ✅ Add trust elements: case examples, values, process
- ✅ Create clear user journeys for different audiences
- ✅ Use action-oriented CTAs: "Book a Consultation" not "Learn More"
- ✅ Include multiple contact methods: phone, email, form

### DON'T:
- ❌ Generic filler: "We deliver exceptional quality"
- ❌ Vague statements: "Quality, integrity, and customer satisfaction"
- ❌ Generic stock photos of random office workers
- ❌ Confetti backgrounds or playful elements
- ❌ Weak CTAs: single "Contact Us" text link
- ❌ Missing location information
- ❌ No trust elements or social proof
