...
const BUSINESS_NAMES = {
  ...
  legal: ['Smith & Associates', 'Justice Law Firm', 'Legal Eagles', 'Corporate Counsel', 'Family Law Partners', 'Criminal Defense Pro', 'Immigration Experts', 'Estate Planning LLC', 'Trademark Lawyers', 'Litigation Masters'],
  ...
  photography: ['Lens Masters', 'Capture Studio', 'Light & Shadow', 'Portrait Pro', 'Wedding Moments', 'Event Photography', 'Commercial Shots', 'Nature Lens', 'Fashion Focus', 'Art Photography'],
  salon: ['Glamour Salon', 'Style Studio', 'Beauty Bar', 'Hair Haven', 'Nail Paradise', 'Spa Retreat', 'Cut & Color', 'The Beauty Spot', 'Luxe Hair', 'Glow Up Studio'],
  construction: ['BuildRight Construction', 'Premier Builders', 'Steel & Stone', 'Foundation Masters', 'Skyline Construction', 'Home Renovators', 'Commercial Builders', 'Quality Contractors', 'Dream Home Builders', 'Concrete Solutions']
};
...
async function testMerlinCommands(projectSlug, businessName) {
  ...
  // Test 20 commands per website (subset for speed)
